...
無意識参加型センシングでは，BLE通信機能とiBeaconの機能を持ったセンサデバイス，iBeaconを検出可能なスマートフォンOS上のセンシングデータ収集アプリケーション，センサデバイスとiBeaconのUUID，Majarコード，Minorコードを管理しセンシングデータ収集を行う管理サーバにより構成される．各機器は以下の機能を持つ．\\
...
%\bibitem{BleElectricPower}
%BLUETOOTH SPECIFICATION Version 4.0, \\https://www.bluetooth.org/ja-jp/specification/adopted-specifications, Retrieved October 2014.
...
%21
%\bibitem{Vital}
%人口統計ラボ,\\http://toukei-labo.com/2010/?tdfk=23\&city=23109\&id=3,
...
%\bibitem{physicalWeb}
%The Physical Web, https://google.github.io/physical-web/, Retrieved October 2015.
